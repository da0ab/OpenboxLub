...
my $cmd="convert \"$imgfile\" -layers flatten -colorspace RGB -strip -resize \"130x183>\"  \"$th_full\"";
		print "$cmd\n";
		system($cmd);
	}
	if(-f $th_full){

$$py.="<p><a href=\"rama/$realname\" rel=\"gb_imageset[nice_pics11]\" title=\"\"><img src=\"rama/t/$realname\" alt=\"\"  /></a><br /> <br /> <br /> <i> </i></p> \n";


	#	$$py.="<img src=\"i/$realname\"   alt=\"\" title=\"\" />\n";
		$thnum++;
	}
}
